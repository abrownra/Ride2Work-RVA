...
import RiderScheduleWeek from './RiderScheduleWeek'
import RiderMySchedule from './RiderMySchedule'
...
export default function RiderApp() {
  ...
  if (screen === SCREENS.DASHBOARD)
    return (
      <RiderDashboard
        ...
        onScheduleWeek={() => setScreen(SCREENS.SCHEDULE_WEEK)}
        onMySchedule={() => setScreen(SCREENS.MY_SCHEDULE)}
  ...
  if (screen === SCREENS.SCHEDULE_WEEK)
    return (
      <RiderScheduleWeek
        rider={rider}
        onSuccess={handleRequestSuccess}
