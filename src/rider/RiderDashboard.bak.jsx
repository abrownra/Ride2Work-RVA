...
export default function RiderDashboard({ rider, onRequest, onScheduleWeek, onMySchedule, onDetail, onLogout }) {
    ...
    <div className="screen">
      ...
      <div className="screen-body">
        ...
        <div style={{ display: 'flex', gap: 10 }}>
          <button className="btn btn-outline" style={{ flex: 1 }} onClick={onScheduleWeek}>
            📅 This Week
          </button>
          <button className="btn btn-outline" style={{ flex: 1 }} onClick={onMySchedule}>
            ⚙️ My Schedule
          </button>
        </div>
